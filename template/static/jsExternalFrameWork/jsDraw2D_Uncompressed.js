...
function jsGraphics(canvasDivElement)
{
	...
	//16-12-28-ls
	//Create One Div When Building A Graphics Constructor
	//Do Not Create In The drawLine Method
	var lineDiv;
	var lineCreateDiv=document.createElement("div");
	...
	function drawLine(pen,point0,point1)
	{
	  ...
	  lineDiv=canvasDiv.appendChild(lineCreateDiv);
    ...
    function drawPolyline(pen,points)
    {
	    ...
	    {
		    polyDiv.appendChild(this.drawLine(pen,points[i-1],points[i]));
	    }
